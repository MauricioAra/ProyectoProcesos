...
public class TaskResourceIntTest {
    ...
    private static final Double DEFAULT_REAL_HOUR = 1D;
    private static final Double UPDATED_REAL_HOUR = 2D;
    ...
    public void createTask() throws Exception {
        ...
        assertThat(testTask.isStatus()).isEqualTo(DEFAULT_STATUS);
        assertThat(testTask.getRealHour()).isEqualTo(DEFAULT_REAL_HOUR);
    }
    ...
    public void getAllTasks() throws Exception {
        ...
        restTaskMockMvc.perform(get("/api/tasks?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].realHour").value(hasItem(DEFAULT_REAL_HOUR.doubleValue())));
    }
    ...
    public void getTask() throws Exception {
        ...
        restTaskMockMvc.perform(get("/api/tasks/{id}", task.getId()))
            ...
            .andExpect(jsonPath("$.realHour").value(DEFAULT_REAL_HOUR.doubleValue()));
    }
    ...
    public void updateTask() throws Exception {
        ...
        assertThat(testTask.isStatus()).isEqualTo(UPDATED_STATUS);
        assertThat(testTask.getRealHour()).isEqualTo(UPDATED_REAL_HOUR);
    }
