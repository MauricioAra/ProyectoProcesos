...
public class ProjectResourceIntTest {
    ...
    public void createProject() throws Exception {
        ...
        assertThat(testProject.getTechnology()).isEqualTo(DEFAULT_TECHNOLOGY);
        assertThat(testProject.getDevice()).isEqualTo(DEFAULT_DEVICE);
    }
    ...
    public void updateProject() throws Exception {
        ...
        assertThat(testProject.getTechnology()).isEqualTo(UPDATED_TECHNOLOGY);
        assertThat(testProject.getDevice()).isEqualTo(UPDATED_DEVICE);
    }
